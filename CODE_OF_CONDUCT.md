...
issues, discussions, and wiki, the classroom, and course channels — and also applies
when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported
to the instructor at **carrolld@newschool.edu**. If a report concerns the
instructor, or you prefer another channel, contact the Design & Technology program
director or use the university's reporting resources. All complaints will be
...
community. (In a course context, serious violations are also governed by university
policy and will be referred accordingly.)
...
We adopt it in the same form as the
[ROCKNIX Code of Conduct](https://rocknix.org/contribute/code-of-conduct/), an
open-source community whose practices this course studies and endorses.
